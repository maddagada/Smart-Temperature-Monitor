...
**Procedure 1:**
 * The one who is willing to install my app, they can clone my repository through the link 
 [Clone Repository](https://github.com/maddagada/Smart-Temperature-Monitor.git)
